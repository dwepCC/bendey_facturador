...
class App_KernelTestDebugContainer extends Container
{
    ...
    {
        return $this->privates['App\\Service\\EmpresasService'] = new \App\Service\EmpresasService(($this->privates['App\\Repository\\EmpresaRepository'] ?? $this->getEmpresaRepositoryService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), 'D:\\lycet/data');
    }
