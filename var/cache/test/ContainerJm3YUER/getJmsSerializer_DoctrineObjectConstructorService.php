...
class getJmsSerializer_DoctrineObjectConstructorService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['jms_serializer.doctrine_object_constructor'] = new \JMS\Serializer\Construction\DoctrineObjectConstructor(($container->services['doctrine'] ?? $container->load('getDoctrineService')), ($container->privates['jms_serializer.doctrine_object_constructor.inner'] ??= new \JMS\Serializer\Construction\UnserializeObjectConstructor()), 'null');
    }
}
