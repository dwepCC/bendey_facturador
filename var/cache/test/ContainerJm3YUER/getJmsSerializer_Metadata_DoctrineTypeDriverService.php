...
class getJmsSerializer_Metadata_DoctrineTypeDriverService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['jms_serializer.metadata.doctrine_type_driver'] = new \JMS\Serializer\Metadata\Driver\DoctrineTypeDriver(($container->privates['jms_serializer.metadata.doctrine_type_driver.inner'] ?? $container->load('getJmsSerializer_Metadata_DoctrineTypeDriver_InnerService')), ($container->services['doctrine'] ?? $container->load('getDoctrineService')), ($container->privates['jms_serializer.type_parser'] ??= new \JMS\Serializer\Type\Parser()));
    }
}
