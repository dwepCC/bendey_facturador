...
class App_KernelTestDebugContainer extends Container
{
    ...
    {
        if (true === $lazyLoad) {
            return $container->privates['uri_signer'] = $container->createProxy('UriSignerGhostEd2fca6', static fn () => \UriSignerGhostEd2fca6::createLazyGhost(static fn ($proxy) => self::getUriSignerService($container, $proxy)));
        }
