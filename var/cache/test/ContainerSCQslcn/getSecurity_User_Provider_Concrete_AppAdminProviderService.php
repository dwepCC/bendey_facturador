 ...
 */
class getSecurity_User_Provider_Concrete_AppAdminProviderService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.user.provider.concrete.app_admin_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider(($container->services['doctrine'] ?? $container->load('getDoctrineService')), 'App\\Entity\\AdminUser', 'username', NULL);
    }
}
