...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getPdfReportDecoratorService()
    {
        ...
        return $this->services['App\\Service\\PdfReportDecorator'] = new \App\Service\PdfReportDecorator(new \App\Service\HtmlReportDecorator(new \Greenter\Report\HtmlReport($this->getEnv('default::TEMPLATESPDF_PATH'), ['cache' => $this->targetDir.'', 'strict_variables' => true]), ($this->services['Greenter\\Report\\Resolver\\TemplateResolverInterface'] ?? ($this->services['Greenter\\Report\\Resolver\\TemplateResolverInterface'] = new \Greenter\Report\Resolver\DefaultTemplateResolver()))), $this->getEnv('WKHTMLTOPDF_PATH'), [0 => 'no-outline', 1 => 'print-media-type'], \dirname(__DIR__, 4));
    }
    ...
    protected function getCache_AppService()
    {
        ...
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('hjkK7f1eS6', 0, ($this->targetDir.''.'/pools/app'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2V8oaM+pX1', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getFiscalBulkActionServiceService()
    {
        ...
        return $this->privates['App\\Service\\Fiscal\\FiscalBulkActionService'] = new \App\Service\Fiscal\FiscalBulkActionService(($this->privates['App\\Repository\\FiscalDocumentRepository'] ?? $this->getFiscalDocumentRepositoryService()), ($this->privates['App\\Service\\Fiscal\\FiscalQueueService'] ?? $this->getFiscalQueueServiceService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3mVfYGNhOK', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getJmsSerializer_DatetimeHandlerService()
    {
        ...
        return $this->privates['jms_serializer.datetime_handler'] = new \JMS\Serializer\Handler\DateHandler('Y-m-d\\TH:i:sP', 'Europe/Berlin', true, [0 => 'Y-m-d\\TH:i:sP']);
    }
    ...
    protected function getJmsSerializer_Metadata_TypedPropertiesDriverService()
    {
        ...
        $a = new \JMS\SerializerBundle\Debug\TraceableFileLocator(new \Metadata\Driver\FileLocator(['Greenter\\Model' => 'D:/tukifac_premium_prod/facturador_lycet/config/serializer']));
