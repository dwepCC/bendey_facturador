...
class getJmsSerializerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $c->registerHandler(2, 'Symfony\\Component\\Clock\\DatePoint', 'json', ['jms_serializer.datetime_handler', 'deserializeDatePointFromjson']);
        $c->registerHandler(2, 'Symfony\\Component\\Clock\\DatePoint', 'xml', ['jms_serializer.datetime_handler', 'deserializeDatePointFromxml']);
        ...
        $c->registerHandler(1, 'Symfony\\Component\\Clock\\DatePoint', 'json', ['jms_serializer.datetime_handler', 'serializeSymfony\\Component\\Clock\\DatePoint']);
        $c->registerHandler(1, 'Symfony\\Component\\Clock\\DatePoint', 'xml', ['jms_serializer.datetime_handler', 'serializeSymfony\\Component\\Clock\\DatePoint']);
