 ...
 */
class getDocumentRequestService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['App\\Service\\DocumentRequest'] = new \App\Service\DocumentRequest(($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), new \App\Service\DocumentRequestParser(($container->services['jms_serializer'] ?? $container->load('getJmsSerializerService'))), $container);
    }
}
