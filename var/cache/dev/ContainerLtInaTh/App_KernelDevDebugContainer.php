...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\FiscalFilesController' => 'getFiscalFilesControllerService',
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.request', [#[\Closure(name: 'App\\EventSubscriber\\MustChangePasswordSubscriber')] fn () => ($container->privates['App\\EventSubscriber\\MustChangePasswordSubscriber'] ?? self::getMustChangePasswordSubscriberService($container)), 'onKernelRequest'], 8);
        $instance->addListener('kernel.request', [#[\Closure(name: 'App\\EventSubscriber\\TokenSubscriber')] fn () => ($container->privates['App\\EventSubscriber\\TokenSubscriber'] ?? self::getTokenSubscriberService($container)), 'onKernelRequest'], 0);
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\AccountController', 'App\\Controller\\FiscalDashboardController', 'App\\Controller\\FiscalEmpresasController', 'App\\Controller\\FiscalFilesController', 'App\\Controller\\HomeController', 'App\\Controller\\SecurityController', 'App\\Controller\\v1\\ConfigurationController', 'App\\Controller\\v1\\DespatchController', 'App\\Controller\\v1\\EmpresasController', 'App\\Controller\\v1\\FiscalController', 'App\\Controller\\v1\\FiscalOperationsController', 'App\\Controller\\v1\\InvoiceController', 'App\\Controller\\v1\\NoteController', 'App\\Controller\\v1\\PerceptionController', 'App\\Controller\\v1\\RetentionController', 'App\\Controller\\v1\\ReversionController', 'App\\Controller\\v1\\SaleController', 'App\\Controller\\v1\\SummaryController', 'App\\Controller\\v1\\VoidedController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    protected static function getJmsSerializer_AuthorizationCheckerService($container)
    {
        ...
        return $container->services['jms_serializer.authorization_checker'] = $instance;
    }
     ...
     */
    protected static function getMustChangePasswordSubscriberService($container)
    {
        $a = ($container->privates['security.helper'] ?? self::getSecurity_HelperService($container));

        if (isset($container->privates['App\\EventSubscriber\\MustChangePasswordSubscriber'])) {
            return $container->privates['App\\EventSubscriber\\MustChangePasswordSubscriber'];
        }

        $instance = new \App\EventSubscriber\MustChangePasswordSubscriber($a, ($container->services['router'] ?? self::getRouterService($container)));

        if (isset($container->privates['App\\EventSubscriber\\MustChangePasswordSubscriber'])) {
            return $container->privates['App\\EventSubscriber\\MustChangePasswordSubscriber'];
        }

        return $container->privates['App\\EventSubscriber\\MustChangePasswordSubscriber'] = $instance;
    }
     ...
     */
    protected static function getTokenSubscriberService($container)
    {
        $a = ($container->privates['security.helper'] ?? self::getSecurity_HelperService($container));

        if (isset($container->privates['App\\EventSubscriber\\TokenSubscriber'])) {
            return $container->privates['App\\EventSubscriber\\TokenSubscriber'];
        }

        $instance = new \App\EventSubscriber\TokenSubscriber($container->getEnv('CLIENT_TOKEN'), $a);

        if (isset($container->privates['App\\EventSubscriber\\TokenSubscriber'])) {
            return $container->privates['App\\EventSubscriber\\TokenSubscriber'];
        }

        return $container->privates['App\\EventSubscriber\\TokenSubscriber'] = $instance;
    }
    ...
    protected static function getDebug_Security_FirewallService($container)
    {
        ...
        $b->registerListener('main', 'admin_logout', 'logout', '_csrf_token', NULL, NULL);

        $instance = new \Symfony\Bundle\SecurityBundle\Debug\TraceableFirewallListener(($container->privates['security.firewall.map'] ?? self::getSecurity_Firewall_MapService($container)), $a, $b);
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'token' => $container->getEnv('CLIENT_TOKEN'),
